            ...
            <div class="hero">
                <div class="hero__content">
                    <h1 class="hero__title">
                        Lower interest rate <span class="underline">guarantee</span><br>
                        on your home mortgage
                    </h1>
                    <p class="hero__text">
                        Fast and Free consultation, use<br>
                        Interest Rate Research for the lowest<br>
                        interest rate available today from the top lenders
                    </p>
                </div>
        ...
        <div class="card card--guarantee">
            <div class="guarantee">
                <div class="guarantee__content">
                    <h1 class="guarantee__title">Lower Interest Rate Guarantee</h1>
                    <p class="guarantee__text">
                        Our Lower Interest Rate Guarantee is unique and built on research.
                        Through a nationwide network of mortgage professionals, we focus on
                        providing access to the lowest mortgage interest rate in the market.
                    </p>
        ...
        <div class="card card--step">
            <div class="step">
                ...
                <p class="step__intro">
                    ...
                    for the lowest inPut our gaurnanteterest
                </p>
                ...
                <div class="step__features">
                    <div class="feature">
                        ...
                        <p class="feature__text">
                            You will benefit from real time pricing<br>
    ...
    <section class="section">
        <div class="card card--step">
            <div class="step">
                ...
                <h2 class="step__subtitle">You got the lower rate!</h2>
                <p class="step__text">
                    Your IRR Pro will work with you through closing<br>
                    Fast and efficient. Read what our customers have to say &rarr;
                </p>
    ...
    <section class="section">
        <div class="card">
            <div class="research">
                ...
                <h1 class="research__title">Benefits of shopping around<br>when buying a home</h1>
                <p class="research__subtitle">A center-aligned collection of statements from neutral, authoritative institutions.</p>

                <div class="research__divider"></div>

                <div class="research__quotes">
                    <div class="quote">
                        <p class="quote__text">"Shopping for a mortgage could save you thousands of dollars."</p>
                    ...
                    <div class="quote">
                        <p class="quote__text">"Comparing loan offers from multiple lenders can help borrowers find the mortgage that best meets their needs."</p>
